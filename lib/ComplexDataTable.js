...
function ComplexTableToolbar(props) {
    ...
    return (react_1.default.createElement(material_1.Toolbar, { sx: __assign(__assign({}, (numSelected > 0 && {
        ...
        numSelected > 0 ? (react_1.default.createElement(material_1.Typography, { sx: __assign({ flex: '1 1 100%' }, labelSx), color: "inherit", variant: "subtitle1", component: "div" },
            numSelected,
            " selected")) : (react_1.default.createElement(material_1.Typography, { sx: __assign({ flex: '1 1 100%' }, labelSx), variant: "h6", id: "tableTitle", component: "div" }, label)),
        action));
}
function ComplexDataTable(props) {
    ...
    return (react_1.default.createElement(material_1.Card, { sx: __assign({ width: '100%', mb: collapseTable === undefined ? 0 : 2, boxShadow: collapseTable === undefined ? 0 : undefined }, sx) },
        toolbarLabel && (react_1.default.createElement(ComplexTableToolbar, { numSelected: selected ? selected.length : 0, label: toolbarLabel, action: toolbarAction, sx: toolbarSx, labelSx: toolbarLabelSx })),
