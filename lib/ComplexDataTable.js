    ...
    return (react_1.default.createElement(material_1.TableHead, null,
        react_1.default.createElement(material_1.TableRow, null,
            ...
            headCells.map(function (headCell) { return (react_1.default.createElement(styles_2.StyledTableCell, { key: headCell.id, align: headCell.align, padding: headCell.disablePadding ? 'none' : 'normal', sortDirection: orderBy === headCell.id ? order : false },
                react_1.default.createElement(material_1.TableSortLabel, { active: orderBy === headCell.id, direction: orderBy === headCell.id ? order : 'asc', onClick: createSortHandler(headCell.id), sx: __assign({}, headCellSx) },
                    headCell.label,
...
function ComplexTableToolbar(props) {
    ...
    return (react_1.default.createElement(material_1.Toolbar, { sx: __assign(__assign({}, (numSelected > 0 && {
            bgcolor: function (theme) {
                return (0, styles_1.alpha)(theme.palette.primary.main, theme.palette.action.activatedOpacity);
            },
        })), sx) },
        numSelected > 0 ? (react_1.default.createElement(material_1.Typography, { sx: __assign({ flex: '1 1 100%' }, labelSx), color: "inherit", variant: "subtitle1", component: "div" },
            numSelected,
            " selected")) : label !== undefined ? (react_1.default.createElement(material_1.Typography, { sx: __assign({ flex: '1 1 100%' }, labelSx), variant: "h6", id: "tableTitle", component: "div" }, label)) : null,
        action));
}
function ComplexDataTable(props) {
    var defaultKey = props.defaultKey, _a = props.dense, dense = _a === void 0 ? false : _a, headCells = props.headCells, headCellSx = props.headCellSx, rows = props.rows, selected = props.selected, setSelected = props.setSelected, sx = props.sx, rowCells = props.rowCells, collapseTable = props.collapseTable, collapseTableHeader = props.collapseTableHeader, handleRowClick = props.handleRowClick, toolbarLabel = props.toolbarLabel, toolbarAction = props.toolbarAction, _b = props.enabledNavigate, enabledNavigate = _b === void 0 ? true : _b, toolbarSx = props.toolbarSx, toolbarLabelSx = props.toolbarLabelSx, rowsPerPageOptions = props.rowsPerPageOptions, _c = props.stickyHeader, stickyHeader = _c === void 0 ? false : _c, tableContainerSx = props.tableContainerSx;
    ...
    return (react_1.default.createElement(material_1.Card, { sx: __assign({ width: '100%', mb: collapseTable === undefined ? 0 : 2, boxShadow: collapseTable === undefined ? 0 : undefined, overflow: stickyHeader ? 'hidden' : undefined }, sx) },
        (toolbarLabel || (selected ? selected.length : 0) > 0) && (react_1.default.createElement(ComplexTableToolbar, { numSelected: selected ? selected.length : 0, label: toolbarLabel, action: toolbarAction, sx: toolbarSx, labelSx: toolbarLabelSx })),
        react_1.default.createElement(material_1.TableContainer, { sx: tableContainerSx },
                        ...
                        return (react_1.default.createElement(react_1.default.Fragment, null,
                            react_1.default.createElement(material_1.TableRow, { hover: true, onClick: function (event) { return onHandleRowClick(event, "".concat(row.id)); }, role: enableSelected ? 'checkbox' : 'list', "aria-checked": isItemSelected, tabIndex: -1, key: "".concat(row.id), selected: isItemSelected, sx: {
                                ...
                                enableSelected && (react_1.default.createElement(styles_2.StyledTableCell, { padding: "checkbox" },
                                    react_1.default.createElement(material_1.Checkbox, { color: "primary", checked: isItemSelected, onChange: function (event, _) {
                            ...
                            collapseTable && (react_1.default.createElement(material_1.TableRow, null,
                                ...
                                react_1.default.createElement(styles_2.StyledCollapseTableCell, { colSpan: headCells.length },
                                    react_1.default.createElement(material_1.Collapse, { in: isOpenCollapse[row.id], timeout: "auto" },
        ...
        enabledNavigate && (react_1.default.createElement(material_1.TablePagination, { rowsPerPageOptions: rowsPerPageOptions !== null && rowsPerPageOptions !== void 0 ? rowsPerPageOptions : [5, 10, 25], component: "div", count: rows.length, rowsPerPage: rowsPerPage, page: page, onPageChange: handleChangePage, onRowsPerPageChange: handleChangeRowsPerPage }))));
}
