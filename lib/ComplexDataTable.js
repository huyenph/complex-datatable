...
function ComplexDataTable(props) {
    ...
    return (react_1.default.createElement(material_1.Card, { sx: __assign({ width: '100%', mb: collapseTable === undefined ? 0 : 20, boxShadow: collapseTable === undefined ? 0 : undefined, overflow: stickyHeader ? 'hidden' : undefined }, sx) },
        ...
        react_1.default.createElement(material_1.TableContainer, { sx: tableContainerStyle },
                            ...
                            collapseTable && (react_1.default.createElement(material_1.TableRow, null,
                                react_1.default.createElement(styles_2.StyledCollapseTableCell, { colSpan: headCells.length + 1 + (enableSelected ? 1 : 0) },
                                    react_1.default.createElement(material_1.Collapse, { in: isOpenCollapse[row.id], timeout: "auto" },
                                        react_1.default.createElement(material_1.Box, { sx: __assign({ padding: 4 }, collapseWrapperStyle) },
