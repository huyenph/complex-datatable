...
function ComplexDataTable(props) {
    var defaultKey = props.defaultKey, _a = props.dense, dense = _a === void 0 ? false : _a, headCells = props.headCells, headCellSx = props.headCellSx, rows = props.rows, selected = props.selected, setSelected = props.setSelected, sx = props.sx, rowCells = props.rowCells, collapseTable = props.collapseTable, handleRowClick = props.handleRowClick, toolbarLabel = props.toolbarLabel, toolbarAction = props.toolbarAction, _b = props.enabledNavigate, enabledNavigate = _b === void 0 ? true : _b, toolbarSx = props.toolbarSx, toolbarLabelSx = props.toolbarLabelSx, rowsPerPageOptions = props.rowsPerPageOptions, _c = props.stickyHeader, stickyHeader = _c === void 0 ? false : _c, tableContainerSx = props.tableContainerSx;
