...
function ComplexTableToolbar(props) {
    ...
    return (<material_1.Toolbar sx={__assign({ pl: {
                sm: 2,
            }, pr: {
                xs: 1,
                sm: 1,
      ...
      {numSelected > 0 ? (<material_1.Typography sx={{
                flex: '1 1 100%',
            }} color="inherit" variant="subtitle1" component="div">
          {numSelected} selected
        </material_1.Typography>) : (<material_1.Typography sx={{
                flex: '1 1 100%',
      ...
      <material_1.TableContainer>
        <material_1.Table sx={{
          ...
          <styles_2.StyledTableBody>
            ...
            return (<>
                  <material_1.TableRow hover onClick={function (event) { return onHandleClick(event, row.name); }} role={handleSelectAllClick !== undefined ? 'checkbox' : 'list'} aria-checked={isItemSelected} tabIndex={-1} key={row.name} selected={isItemSelected} sx={{
                    cursor: 'pointer',
                }}>
...
//# sourceMappingURL=ComplexDataTable.jsx.map